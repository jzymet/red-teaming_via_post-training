"""
analysis/plotting.py — ASR + diversity curves over training rounds.

The money plot: diversity collapses as ASR plateaus → mode collapse.
"""
...
def load_metrics(rollouts_path: str) -> dict:
    ...
    return {"rounds": round_ids, "asr": asrs, "diversity": diversities}
...
def plot_collapse(rollouts_path: str, output_path: str = "collapse.png"):
    ...
    ax1.plot(metrics["rounds"], metrics["asr"], color="crimson", linewidth=2)
    ...
    ax2.plot(
        metrics["rounds"], metrics["diversity"],
